...
const AboutPop = () => {
    return (
        <PopWrapper>
            <Path color="" />
            <div className='z-50 max-w-xl md:max-w-none overflow-clip text-white bg-black md:bg-black/[.75] absolute top-24 md:top-16 right-12 md:right-0 p-6 rounded-xl fade-display'>
